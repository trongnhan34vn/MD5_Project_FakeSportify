            ...
            <div id='login' className='w-[448px] mx-auto'>
                ...
                <section className='font-CircularMedium login-wrap max-w-md mx-auto'>
                    ...
                    <div className="font-CircularBold login-with flex flex-col gap-2.5">
                        ...
                        <button className='hover:border-[#1877f2] h-[56px] border border-[#878787] rounded-[500px] uppercase tracking-widest text-sm bg-[#1877f2] text-[#fff] py-[13px] flex justify-center items-center'>
                            <i className="fa-brands fa-square-facebook mr-2.5 text-lg"></i>
                            <span className=''>Continue With Facbook</span>
                        </button>
                        <button className='hover:border-[#1877f2] h-[56px] border border-[#878787] rounded-[500px] uppercase tracking-widest text-sm bg-[#000] text-[#fff] py-[13px] flex justify-center items-center'>
                            <i className="fa-brands fa-apple mr-2.5 text-lg "></i>
                            <span className=''>Continue With Apple</span>
                        </button>
                        <button className='hover:border-[#1877f2] h-[56px] border border-[#878787] leading-7 rounded-[500px] uppercase tracking-widest text-sm py-[13px] flex justify-center items-center'>
                    ...
                    <form className="text-left">
                        ...
                        <div className='mb-5 flex justify-between '>
                            ...
                            <button onClick={handleSubmit} className='transition-all ease-in-out duration-150 hover:scale-110 btn-submit text-sm px-8 py-3 bg-[#1ed760] uppercase rounded-[500px] tracking-widest'>Log in</button>
                        </div>
