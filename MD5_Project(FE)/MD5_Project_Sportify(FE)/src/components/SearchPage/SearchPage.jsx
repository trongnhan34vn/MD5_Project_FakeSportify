...
const SearchPage = () => {
    ...
    const elementCategory = listCategories.map((category) => {
        return <div key={category.id} className='group relative album-item bg-[#181818] max-w-[200px] rounded hover:bg-[#282828] transition-all duration-300'>
        ...
        <button className='block w-full album-wrap p-4'>
            ...
            <div className='album-content w-full text-left overflow-hidden text-[#fff]'>
                <h3 className='font-CircularMedium text-base mb-1 truncate'>{category.name}</h3>
