...
export default function IndexOnSearch() {
    ...
    return (
        <div className='list-playlists transition-all opacity-100 ease-in-out duration-400 pt-[120px] ml-[241px] flex flex-col gap-6 py-6 bg-[linear-gradient(#1f1f1f,#121212)]'>
