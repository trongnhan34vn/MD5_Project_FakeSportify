...
export default function IndexOnSearch() {
    ...
    const handleToArtistAudio = (id) => {
        dispatch(actions.findArtistById(id))
        navigate('/search-result', {state: {result: 'artist'}});
    }
    ...
    return (
        <div className='list-playlists transition-all min-h-screen opacity-100 ease-in-out duration-400 pt-[120px] ml-[241px] flex flex-col gap-6 py-6 bg-[linear-gradient(#1f1f1f,#121212)]'>
