...
import { albumSelector, artistSelector, audioSelector } from '../../../redux/selector';
...
const OnSearch = () => {
    ...
    const albumSearch = useSelector(albumSelector)
                ...
                <div className='list-playlists-item px-8 mb-4'>
                    ...
                    <div className='list-playlists-item list-albums'>
                        ...
                        <table className='w-1/2'>
                            <tbody>
                                <tr className='hover:bg-[hsla(0,0%,100%,.1)] block p-2 rounded-md group'>
                                    <td width={"6%"}>
                                    ...
                                    <td width={"60%"} className='text-[#fff]'>
                                        <div className='flex flex-col'>
                                            <h4 className='text-[16px] font-CircularMedium hover:underline mr-auto inline-block cursor-pointer'>Tình đơn phương</h4>
                                            <p className='text-[14px] font-CircularLight hover:underline mr-auto inline-block cursor-pointer'>Tùng Acoustic</p>
                                        </div>
                                    </td>
                                    <td width={"5%"}>
                                        <p className='text-[#fff] text-[14px] font-CircularLight'>4:44</p>
                                    </td>
                                </tr>
